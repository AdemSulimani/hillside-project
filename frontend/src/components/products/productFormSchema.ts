...
export const productFormValuesSchema = z
  .object({
    ...
    flavor: z.string().max(255).optional().default(''),
    size: z.string().max(255).optional().default(''),
    color: z.string().max(255).optional().default(''),
    variant: z.string().max(255).optional().default(''),
