...
Set is_product_knowledge_question true when the customer needs factual catalog information (including attribute questions, or ingredients/material/details from the product description). False for: usage/dosage/how-to-take ONLY, price/cost questions (even when they include an attribute qualifier such as "price of the orange-flavored one", "how much does the large one cost", "what is the cost of the strawberry variant"), pure recommendations, greetings, order placement, and business-info questions (location, address, opening hours, contact details, delivery methods/policy, about the business).
